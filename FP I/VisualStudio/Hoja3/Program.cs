...
namespace Hoja3
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Hi! Give me four numbers and I'll tell you if there's a 3 in it!");
            ...
            isIt3 = (num1 == 3) || (num2 == 3) || (num3 == 3) || (num4 == 3);
            

            Console.WriteLine("The fact that your number has a 3 in it is " + isIt3);
